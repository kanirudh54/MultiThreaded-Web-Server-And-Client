...
class Server:
 ...
 def __init__(self, port):
     ...
     print("port:",port)
     self.port = port
     self.www_dir = 'C:\\' #Directory for webpage Files are Stored.
 ...
 def handle_client(self,client_socket):
    ...
    if (request_method == 'GET') | (request_method == 'HEAD'):
       ...
       try:
           ...
           webbrowser.open(file_request) #Open The Html File On browser
       except Exception as e: # not found, generate 404 page
           print ("Warning, file not found. Serving response code 404\n",e)
           response_headers = self.generate_headers( 404)
           webbrowser.open("c:\\404.html")  #Open The HTML File on The Browser     
           if (request_method == 'GET'):
